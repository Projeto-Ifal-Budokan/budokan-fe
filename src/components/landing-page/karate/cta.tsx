...
export const CTASection = () => {
  ...
  const handleScheduleClick = () => {
    openWhatsApp(
      'Olá! Gostaria de agendar uma aula experimental de Karate-Do na Budokan-Ryu.'
    );
  };
  ...
  const handleContactClick = () => {
    openWhatsApp(
      'Olá! Gostaria de mais informações sobre o Karate-Do na Budokan-Ryu.'
    );
  };
